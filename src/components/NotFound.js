...
function NotFound() {
  return (
    <div className="min-h-screen bg-[#19147A]">
      ...
      >
        <h1 class="mb-4 px-6 pt-12 text-5xl font-extrabold text-white">
        ...
        <Link to="/">
          <a class="mx-6 relative inline-flex items-center justify-start inline-block px-5 py-3 overflow-hidden font-bold group">
