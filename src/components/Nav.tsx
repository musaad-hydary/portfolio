      ...
      <div className="max-w-[800px] mx-auto px-7 flex justify-between items-center py-6">
        ...
        <div className="flex items-center gap-6">
          {links.map(l => (
            ...
            >
              <span className="block sm:hidden text-[0.7rem] tracking-wider">{l.icon}</span>
              <span className="hidden sm:block text-[0.65rem] uppercase tracking-[0.13em]">{l.label}</span>
            </a>
          ))}
        </div>
      </div>
